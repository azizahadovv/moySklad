...
public class AdminSupport {
    ...
    static final List<String> SOZLASH_MENU =
            List.of("🏪 Касса", "👥 Фойдаланувчилар", "💼 Бошланғич қолдиқ",
                    "🛠 Корректировка", "📋 Аудит",
                    "🏷 Тугма номлари", "🧩 Меню тартиби", "🔑 MoySklad API", "🔄 Номлар (MoySklad)", "🕵️ Назорат", "🏬 Омбор назорати", "📨 Бот хабарлари", "⚖️ Жарималар", "👁 Ҳуқуқлар",
                    "📣 Гуруҳлар/Каналлар", "🔔 Билдиришномалар", "🔕 Хабарномалар", "💳 Карта масъуллари", "📅 Ledger санаси",
    ...
    static final List<String> STAT_MENU =
            List.of("💰 Бугунги тушум", "🧾 Расходлар",
                    ...
                    "🏦 Бухгалтерия", "💼 Салдо", "📲 Кликлар", "📊 Свод", "🏦 Топширилган пуллар");
    ...
    static {
        ...
        SOZ_GROUPS.put("🔗 MoySklad", List.of("🔑 MoySklad API", "🔄 Номлар (MoySklad)",
                "📥 Қайта юклаш", "🩺 Диагностика", "🕵️ Назорат", "🏬 Омбор назорати", "📨 Бот хабарлари", "⚖️ Жарималар"));
        SOZ_GROUPS.put("🎛 Интерфейс", List.of("🏷 Тугма номлари", "🧩 Меню тартиби",
                "🔔 Билдиришномалар", "🔕 Хабарномалар", "📋 Аудит"));
    }
