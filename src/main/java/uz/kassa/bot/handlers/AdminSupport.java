...
public class AdminSupport {
    ...
    static final List<String> SOZLASH_MENU =
            List.of("🏪 Касса", "👥 Фойдаланувчилар", "💼 Бошланғич қолдиқ",
                    "🛠 Корректировка", "📋 Аудит",
                    "🏷 Тугма номлари", "🧩 Меню тартиби", "🔑 MoySklad API", "🔄 Номлар (MoySklad)", "🕵️ Назорат", "🏬 Омбор назорати", "📨 Бот хабарлари", "👁 Ҳуқуқлар",
    ...
    static {
        ...
        SOZ_GROUPS.put("🔗 MoySklad", List.of("🔑 MoySklad API", "🔄 Номлар (MoySklad)",
                "📥 Қайта юклаш", "🩺 Диагностика", "🕵️ Назорат", "🏬 Омбор назорати", "📨 Бот хабарлари"));
